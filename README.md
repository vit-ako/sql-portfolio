...
- Все SQL файлы можно выполнить последовательно
- Нет синтаксических ошибок
- Все таблицы и колонки существуют (в правильном порядке)
- Типы данных совпадают
- Запросы валидны для PostgreSQL 18

### Статус сборки

[![SQL CI - проверка запросов в PostgreSQL](https://github.com/vit-ako/sql-portfolio/actions/workflows/sql-ci.yml/badge.svg)](https://github.com/vit-ako/sql-portfolio/actions/workflows/sql-ci.yml)
